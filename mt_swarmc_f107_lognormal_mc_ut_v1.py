...
nowcast the thermosphere density. The space weather input with variations in F10.7 (MC samples and UT sigma points)
are considered with three different cases for Swarm-C satellite. For the MC & UT simulation, F10.7 samples are obtained from the 
...
- '/lognormal_mc_ut' is included in child_dir_mc_f107,
- '/lognormal_mc_ut' is included in save_folder_mc,
- '/lognormal_mc_ut' is included in child_dir_ut_f107,
